...
function fooding_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'fooding_custom_background_args', array(
...
function fooding_scripts() {
	...
	wp_enqueue_script( 'fooding-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'fooding-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
